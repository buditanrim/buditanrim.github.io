...
Nowadays, icon is often a part of the design system. It's not a surprise because icon is effective to quickly communicate the idea at a glance, like the one in your smartwatch. And I'm fortunate because I had a chance to work on few icon systems for various companies<sup>1</sup>. Along the way, I've encountered some common problems and I want to share it and hopefully useful for you. 
...
**Takeaway:** Less is more. The icon can be visual noise and not helpful when it's too complex. Simplicity is essential in icon design to improve the clarity. However, don't oversimplified the icon because that won't be effective either.


### Too abstract to understand
Study shows that abstract icon has a lower accuracy than the concrete icon [(McDougall & Bruijn, 2001)][mcdougall]{:target="_blank"} and actually trigger a higher cognitive processing load. Concrete icon is friendly to the users since they can reference it based on their real world object or experience.
...
The designer often either forget, neglect, or underestimate the importance of the negative space around the icon. Failing at respecting the negative space can makes your icon looks funky when they're sitting side by side.
...
{% include img.html url="/img/post/sep-2018/icon-problem-balance.gif" url-2="/img/post/sep-2018/icon-problem-balance-2x.gif" alt="Complex icon reduce clarity" %}
...
On the side, it's worth to consider to create a set of principles when you see there are common issues with the icon while audit them. [Reach me out][buditwitter]{:target="_blank"} if you're interested to chat about this.
