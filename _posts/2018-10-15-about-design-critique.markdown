...
One day on the _fresh eyes_<sup id="a1">[1](#fn1)</sup> session. I presented a few explorations without context whatsoever to see how it goes. Later, I noticed people started to shape a very surface-level feedback, while others asked questions to gain the context a bit more.
