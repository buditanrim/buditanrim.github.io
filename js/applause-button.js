    ...
    !(function (t, n) {
        var r = t.document,
            ...
            l = (function (e) {
                ...
                collections: { HTMLAllCollection: ["all"], HTMLCollection: ["forms"], HTMLFormControlsCollection: ["elements"], HTMLOptionsCollection: ["options"] },
                elements: {
                    Element: ["element"],
                    HTMLAnchorElement: ["a"],
        ...
        function je(e) {
            ke && ((ke = !1), e.currentTarget.removeEventListener(S, je)),
                V.length && Fe((e.target || r).querySelectorAll(V), e.detail === T ? T : v),
                pe &&
                    (function () {
        ...
        function Ge(e, t) {
            ...
            -1 < o &&
                (f(e, x[o]),
                (o = 0),
                t !== v || e[v] ? t !== T || e[T] || ((e[v] = !1), (e[T] = !0), (r = "disconnected"), (o = 1)) : ((e[T] = !1), (e[v] = !0), (r = "connected"), (o = 1), pe && U.call(Le, e) < 0 && Le.push(e)),
                        ...
                        if (n) {
                            (t[e] = function (e) {
                                ...
                                return (
                                    e || (e = this),
                                    e[Y] ||
                                        ((oe = !0), (t = le[ae.get(e.constructor)]), ((e = (o = ee && 1 === t.create.length) ? Reflect.construct(n, G, t.constructor) : r.createElement.apply(r, t.create))[Y] = !0), (oe = !1), o || Qe(e)),
                                    e
                                );
                            }),
        ...
        if (
            ...
            _e ||
                      ...
                      (function () {
                          var e = K(fe, C),
                              ...
                              o = function (e) {
                                  ...
                                  r.hasOwnProperty(o) &&
                                      ((r = r[o]),
                                      ((t = new CustomEvent(N, { bubbles: !0 })).attrName = r.name),
                                      (t.prevValue = r.value || null),
                                      (t.newValue = r.value = n[o] || null),
                                      null == t.prevValue ? (t[O] = t.attrChange = 0) : (t.MODIFICATION = t.attrChange = 1),
                                      Me.call(n, t));
                              };
                          (e.value = function (e, l, i) {
                              e === N && this[b] && this.setAttribute !== r && ((this[L] = { className: { name: "class", value: this.className } }), (this.setAttribute = r), (this.removeAttribute = n), t.call(this, "propertychange", o)),
                                  t.call(this, e, l, i);
                          }),
                              Z(fe, C, e);
                      })())
                ...
                (r[h] = function (e, t) {
                    if (
                        ...
                        Ne &&
                            ...
                            me
                                      ...
                                      return new me(function (r) {
                                          for (var o, l, i, a = 0, u = r.length; a < u; a++)
                                              "childList" === (o = r[a]).type
                                                  ...
                                                  : ((l = o.target), Ie && l[b] && "style" !== o.attributeName && (i = Te.call(l, o.attributeName)) !== o.oldValue && l[b](o.attributeName, o.oldValue, i));
                                      });
                                  })(Re(v), Re(T))),
                                  (m = function (e) {
                                ...
                                : ((i = []), r[C]("DOMNodeInserted", Ue(v)), r[C]("DOMNodeRemoved", Ue(T))),
                            r[C](S, je),
                    ...
                    return (
                        ...
                        (o = R.push((u ? I : k) + n) - 1),
                        (V = V.concat(V.length ? "," : "", u ? c + '[is="' + e.toLowerCase() + '"]' : c)),
                        (l.prototype = x[o] = q.call(a, "prototype") ? a.prototype : ce(fe)),
            ...
            try {
                !(function (e, n, o) {
                    if (((n[E] = "a"), ((e.prototype = ce(HTMLAnchorElement.prototype)).constructor = e), t.customElements.define(o, e, n), Te.call(r.createElement("a", { is: o }), "is") !== o || (ee && Te.call(new e(), "is") !== o)))
                        throw n;
                })(
                    function e() {
                                    ...
                                    (this._initialClapCount = new Promise(function (e) {
                                            ...
                                            ((n = function () {
                                                if (e._totalClaps < 10) {
                                                    ...
                                                    (n = e.api),
                                                        (r = t),
                                                        (o = e.url),
                                                        fetch(n + "/update-claps" + (o ? "?url=" + o : ""), { method: "POST", headers: { "Content-Type": "text/plain" }, body: JSON.stringify(r + ",3.3.0") }).then(function (e) {
                                                            return e.text();
                                                        }),
                                                        (e._totalClaps += t),
                                                        (e._bufferedClaps = 0);
                                        ...
                                        this.addEventListener("mousedown", function (t) {
                                            if (0 === t.button && (e.classList.add("clapped"), !e.classList.contains("clap-limit-exceeded"))) {
                                                var n,
                                                    r,
                                                    o = Number(e._countElement.innerHTML.replace(",", "")) + 1;
                                                e.dispatchEvent(new CustomEvent("clapped", { bubbles: !0, detail: { clapCount: o } })),
                                                    (r = "clap"),
                                                    ...
                                                    e.multiclap ? e._bufferedClaps + e._totalClaps >= 10 && e.classList.add("clap-limit-exceeded") : e.classList.add("clap-limit-exceeded");
                                            }
                                        }),
                                        ((i = this.api),
                                        (a = this.url),
                                        fetch(i + "/get-claps" + (a ? "?url=" + a : ""), { headers: { "Content-Type": "text/plain" } }).then(function (e) {
                                            return e.text();
                                        })).then(function (t) {
